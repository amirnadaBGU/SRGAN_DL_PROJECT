...
parser.add_argument('--time_steps', default=20, type=int, help='number of diffusion steps')
...
if __name__ == '__main__':
    ...
    # Wandb definition:
    wandb.login(key="68591fc7177da3394b90d1c3d2ef0183d85215ab")
    project = "SRGAN_DL_PROJECT"
    wandb.init(project=project,entity="ycohen233-ben-gurion-university-of-the-negev")
